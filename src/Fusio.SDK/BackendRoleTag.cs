...
public class BackendRoleTag : TagAbstract {
    ...
    public async Task<CommonMessage> Delete(string roleId)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/role/$role_id<[0-9]+|^~>", pathParams), Method.Delete);
    ...
    public async Task<CommonMessage> Update(string roleId, BackendRoleUpdate payload)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/role/$role_id<[0-9]+|^~>", pathParams), Method.Put);
            this.Parser.Query(request, queryParams, queryStructNames);
    ...
    public async Task<BackendRole> Get(string roleId)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/role/$role_id<[0-9]+|^~>", pathParams), Method.Get);
            this.Parser.Query(request, queryParams, queryStructNames);
    ...
    public async Task<CommonMessage> Create(BackendRoleCreate payload)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/role", pathParams), Method.Post);
            this.Parser.Query(request, queryParams, queryStructNames);
            request.AddJsonBody(JsonSerializer.Serialize(payload));
    ...
    public async Task<BackendRoleCollection> GetAll(int startIndex, int count, string search)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/role", pathParams), Method.Get);
            this.Parser.Query(request, queryParams, queryStructNames);

...
public class BackendAppTag : TagAbstract {
    ...
    public async Task<CommonMessage> DeleteToken(string appId, string tokenId)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/app/$app_id<[0-9]+>/token/:token_id", pathParams), Method.Delete);
    ...
    public async Task<CommonMessage> Create(BackendAppCreate payload)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/app", pathParams), Method.Post);
            this.Parser.Query(request, queryParams, queryStructNames);
            request.AddJsonBody(JsonSerializer.Serialize(payload));
    ...
    public async Task<BackendAppCollection> GetAll(int startIndex, int count, string search)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/app", pathParams), Method.Get);
            this.Parser.Query(request, queryParams, queryStructNames);
    ...
    public async Task<BackendAppToken> GetToken(string tokenId)
    {
        try
        {
            Dictionary<string, object> pathParams = new Dictionary<string, object>();
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/app/token/$token_id<[0-9]+>", pathParams), Method.Get);
            this.Parser.Query(request, queryParams, queryStructNames);
            ...
            if (response.IsSuccessful)
            {
                return this.Parser.Parse<BackendAppToken>(response.Content);
            }
    ...
    public async Task<BackendAppTokenCollection> GetAllTokens(int startIndex, int count, string search, string from, string to, int appId, int userId, int status, string scope, string ip)
    {
        try
        {
            Dictionary<string, object> pathParams = new Dictionary<string, object>();
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/app/token", pathParams), Method.Get);
            this.Parser.Query(request, queryParams, queryStructNames);
            ...
            if (response.IsSuccessful)
            {
                return this.Parser.Parse<BackendAppTokenCollection>(response.Content);
            }

...
public class BackendIdentityTag : TagAbstract {
    ...
    public async Task<CommonMessage> Delete(string identityId)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/identity/$identity_id<[0-9]+|^~>", pathParams), Method.Delete);
    ...
    public async Task<CommonMessage> Update(string identityId, BackendIdentityUpdate payload)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/identity/$identity_id<[0-9]+|^~>", pathParams), Method.Put);
            this.Parser.Query(request, queryParams, queryStructNames);
    ...
    public async Task<BackendIdentity> Get(string identityId)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/identity/$identity_id<[0-9]+|^~>", pathParams), Method.Get);
            this.Parser.Query(request, queryParams, queryStructNames);
    ...
    public async Task<CommonFormContainer> GetForm(string _class)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/identity/form", pathParams), Method.Get);
            this.Parser.Query(request, queryParams, queryStructNames);
    ...
    public async Task<BackendIdentityIndex> GetClasses()
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/identity/list", pathParams), Method.Get);
            this.Parser.Query(request, queryParams, queryStructNames);
    ...
    public async Task<CommonMessage> Create(BackendIdentityCreate payload)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/identity", pathParams), Method.Post);
            this.Parser.Query(request, queryParams, queryStructNames);
            request.AddJsonBody(JsonSerializer.Serialize(payload));
    ...
    public async Task<BackendIdentityCollection> GetAll(int startIndex, int count, string search)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/identity", pathParams), Method.Get);
            this.Parser.Query(request, queryParams, queryStructNames);

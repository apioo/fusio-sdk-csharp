...
public class BackendConfigTag : TagAbstract {
    ...
    public async Task<CommonMessage> Update(string configId, BackendConfigUpdate payload)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/config/$config_id<[0-9]+|^~>", pathParams), Method.Put);
    ...
    public async Task<BackendConfig> Get(string configId)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/config/$config_id<[0-9]+|^~>", pathParams), Method.Get);
            this.Parser.Query(request, queryParams, queryStructNames);
    ...
    public async Task<BackendConfigCollection> GetAll(int startIndex, int count, string search)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/config", pathParams), Method.Get);
            this.Parser.Query(request, queryParams, queryStructNames);

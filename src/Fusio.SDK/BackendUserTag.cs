...
public class BackendUserTag : TagAbstract {
    ...
    public async Task<CommonMessage> Delete(string userId)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/user/$user_id<[0-9]+|^~>", pathParams), Method.Delete);
    ...
    public async Task<CommonMessage> Update(string userId, BackendUserUpdate payload)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/user/$user_id<[0-9]+|^~>", pathParams), Method.Put);
            this.Parser.Query(request, queryParams, queryStructNames);
    ...
    public async Task<BackendUser> Get(string userId)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/user/$user_id<[0-9]+|^~>", pathParams), Method.Get);
            this.Parser.Query(request, queryParams, queryStructNames);
    ...
    public async Task<CommonMessage> Create(BackendUserCreate payload)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/user", pathParams), Method.Post);
            this.Parser.Query(request, queryParams, queryStructNames);
            request.AddJsonBody(JsonSerializer.Serialize(payload));
    ...
    public async Task<BackendUserCollection> GetAll(int startIndex, int count, string search)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/user", pathParams), Method.Get);
            this.Parser.Query(request, queryParams, queryStructNames);
            ...
            if (response.IsSuccessful)
            {
                return this.Parser.Parse<BackendUserCollection>(response.Content);
            }

...
public class BackendRateTag : TagAbstract {
    ...
    public async Task<CommonMessage> Delete(string rateId)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/rate/$rate_id<[0-9]+|^~>", pathParams), Method.Delete);
    ...
    public async Task<CommonMessage> Update(string rateId, BackendRateUpdate payload)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/rate/$rate_id<[0-9]+|^~>", pathParams), Method.Put);
            this.Parser.Query(request, queryParams, queryStructNames);
    ...
    public async Task<BackendRate> Get(string rateId)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/rate/$rate_id<[0-9]+|^~>", pathParams), Method.Get);
            this.Parser.Query(request, queryParams, queryStructNames);
            ...
            if (response.IsSuccessful)
            {
                return this.Parser.Parse<BackendRate>(response.Content);
            }
    ...
    public async Task<CommonMessage> Create(BackendRateCreate payload)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/rate", pathParams), Method.Post);
            this.Parser.Query(request, queryParams, queryStructNames);
            request.AddJsonBody(JsonSerializer.Serialize(payload));
    ...
    public async Task<BackendRateCollection> GetAll(int startIndex, int count, string search)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/rate", pathParams), Method.Get);
            this.Parser.Query(request, queryParams, queryStructNames);
            ...
            if (response.IsSuccessful)
            {
                return this.Parser.Parse<BackendRateCollection>(response.Content);
            }

...
public class BackendWebhookTag : TagAbstract {
    ...
    public async Task<CommonMessage> Delete(string webhookId)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/webhook/$webhook_id<[0-9]+|^~>", pathParams), Method.Delete);
    ...
    public async Task<CommonMessage> Update(string webhookId, BackendWebhookUpdate payload)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/webhook/$webhook_id<[0-9]+|^~>", pathParams), Method.Put);
            this.Parser.Query(request, queryParams, queryStructNames);
    ...
    public async Task<BackendWebhook> Get(string webhookId)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/webhook/$webhook_id<[0-9]+|^~>", pathParams), Method.Get);
            this.Parser.Query(request, queryParams, queryStructNames);
            ...
            if (response.IsSuccessful)
            {
                return this.Parser.Parse<BackendWebhook>(response.Content);
            }
    ...
    public async Task<CommonMessage> Create(BackendWebhookCreate payload)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/webhook", pathParams), Method.Post);
            this.Parser.Query(request, queryParams, queryStructNames);
            request.AddJsonBody(JsonSerializer.Serialize(payload));
    ...
    public async Task<BackendWebhookCollection> GetAll(int startIndex, int count, string search)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/webhook", pathParams), Method.Get);
            this.Parser.Query(request, queryParams, queryStructNames);
            ...
            if (response.IsSuccessful)
            {
                return this.Parser.Parse<BackendWebhookCollection>(response.Content);
            }

...
public class BackendCronjobTag : TagAbstract {
    ...
    public async Task<CommonMessage> Delete(string cronjobId)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/cronjob/$cronjob_id<[0-9]+|^~>", pathParams), Method.Delete);
    ...
    public async Task<CommonMessage> Update(string cronjobId, BackendCronjobUpdate payload)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/cronjob/$cronjob_id<[0-9]+|^~>", pathParams), Method.Put);
            this.Parser.Query(request, queryParams, queryStructNames);
    ...
    public async Task<BackendCronjob> Get(string cronjobId)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/cronjob/$cronjob_id<[0-9]+|^~>", pathParams), Method.Get);
            this.Parser.Query(request, queryParams, queryStructNames);
    ...
    public async Task<CommonMessage> Create(BackendCronjobCreate payload)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/cronjob", pathParams), Method.Post);
            this.Parser.Query(request, queryParams, queryStructNames);
            request.AddJsonBody(JsonSerializer.Serialize(payload));
    ...
    public async Task<BackendCronjobCollection> GetAll(int startIndex, int count, string search)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/cronjob", pathParams), Method.Get);
            this.Parser.Query(request, queryParams, queryStructNames);

...
public class BackendSdkTag : TagAbstract {
    ...
    public async Task<CommonMessage> Generate(BackendSdkGenerate payload)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/sdk", pathParams), Method.Post);
    ...
    public async Task<BackendSdkResponse> GetAll()
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/sdk", pathParams), Method.Get);
            this.Parser.Query(request, queryParams, queryStructNames);

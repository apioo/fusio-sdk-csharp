...
public class BackendSpecificationTag : TagAbstract {
    public BackendSpecificationTag(RestClient httpClient, Parser parser): base(httpClient, parser)
    {
    }
     ...
     */
    public async Task<BackendSpecificationGet> Get()
    {
        ...
        RestRequest request = new(this.Parser.Url("/backend/specification", pathParams), Method.Get);
        ...
        {
            var data = this.Parser.Parse<BackendSpecificationGet>(response.Content);

...
public class BackendConnectionDatabaseTag : TagAbstract {
    public BackendConnectionDatabaseTag(RestClient httpClient, Parser parser): base(httpClient, parser)
    {
    }
    ...
    public async Task<CommonMessage> CreateRow(string connectionId, string tableName, BackendDatabaseRow payload)
    {
        ...
        RestRequest request = new(this.Parser.Url("/backend/connection/:connection_id/database/:table_name/rows", pathParams), Method.Post);
    ...
    public async Task<CommonMessage> CreateTable(string connectionId, BackendDatabaseTable payload)
    {
        ...
        RestRequest request = new(this.Parser.Url("/backend/connection/:connection_id/database", pathParams), Method.Post);
        this.Parser.Query(request, queryParams, queryStructNames);
        request.AddJsonBody(JsonSerializer.Serialize(payload));
    ...
    public async Task<CommonMessage> DeleteRow(string connectionId, string tableName, string id)
    {
        ...
        RestRequest request = new(this.Parser.Url("/backend/connection/:connection_id/database/:table_name/rows/:id", pathParams), Method.Delete);
        this.Parser.Query(request, queryParams, queryStructNames);
    ...
    public async Task<CommonMessage> DeleteTable(string connectionId, string tableName)
    {
        ...
        RestRequest request = new(this.Parser.Url("/backend/connection/:connection_id/database/:table_name", pathParams), Method.Delete);
        this.Parser.Query(request, queryParams, queryStructNames);
    ...
    public async Task<BackendDatabaseRow> GetRow(string connectionId, string tableName, string id)
    {
        ...
        RestRequest request = new(this.Parser.Url("/backend/connection/:connection_id/database/:table_name/rows/:id", pathParams), Method.Get);
        this.Parser.Query(request, queryParams, queryStructNames);
    ...
    public async Task<BackendDatabaseRowCollection> GetRows(string connectionId, string tableName, int startIndex, int count, string filterBy, string filterOp, string filterValue, string sortBy, string sortOrder, string columns)
    {
        ...
        RestRequest request = new(this.Parser.Url("/backend/connection/:connection_id/database/:table_name/rows", pathParams), Method.Get);
        this.Parser.Query(request, queryParams, queryStructNames);
    ...
    public async Task<BackendDatabaseTable> GetTable(string connectionId, string tableName)
    {
        ...
        RestRequest request = new(this.Parser.Url("/backend/connection/:connection_id/database/:table_name", pathParams), Method.Get);
        this.Parser.Query(request, queryParams, queryStructNames);
    ...
    public async Task<BackendDatabaseTableCollection> GetTables(string connectionId, int startIndex, int count)
    {
        ...
        RestRequest request = new(this.Parser.Url("/backend/connection/:connection_id/database", pathParams), Method.Get);
        this.Parser.Query(request, queryParams, queryStructNames);
    ...
    public async Task<CommonMessage> UpdateRow(string connectionId, string tableName, string id, BackendDatabaseRow payload)
    {
        ...
        RestRequest request = new(this.Parser.Url("/backend/connection/:connection_id/database/:table_name/rows/:id", pathParams), Method.Put);
        this.Parser.Query(request, queryParams, queryStructNames);
        request.AddJsonBody(JsonSerializer.Serialize(payload));
    ...
    public async Task<CommonMessage> UpdateTable(string connectionId, string tableName, BackendDatabaseTable payload)
    {
        ...
        RestRequest request = new(this.Parser.Url("/backend/connection/:connection_id/database/:table_name", pathParams), Method.Put);
        this.Parser.Query(request, queryParams, queryStructNames);
        request.AddJsonBody(JsonSerializer.Serialize(payload));

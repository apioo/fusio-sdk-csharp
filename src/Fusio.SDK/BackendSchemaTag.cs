...
public class BackendSchemaTag : TagAbstract {
    ...
    public async Task<CommonMessage> Delete(string schemaId)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/schema/$schema_id<[0-9]+|^~>", pathParams), Method.Delete);
    ...
    public async Task<CommonMessage> Update(string schemaId, BackendSchemaUpdate payload)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/schema/$schema_id<[0-9]+|^~>", pathParams), Method.Put);
            this.Parser.Query(request, queryParams, queryStructNames);
    ...
    public async Task<BackendSchema> Get(string schemaId)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/schema/$schema_id<[0-9]+|^~>", pathParams), Method.Get);
            this.Parser.Query(request, queryParams, queryStructNames);
    ...
    public async Task<CommonMessage> UpdateForm(string schemaId, BackendSchemaForm payload)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/schema/form/$schema_id<[0-9]+>", pathParams), Method.Put);
            this.Parser.Query(request, queryParams, queryStructNames);
            request.AddJsonBody(JsonSerializer.Serialize(payload));
    ...
    public async Task<BackendSchemaPreviewResponse> GetPreview(string schemaId)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/schema/preview/:schema_id", pathParams), Method.Post);
            this.Parser.Query(request, queryParams, queryStructNames);
    ...
    public async Task<CommonMessage> Create(BackendSchemaCreate payload)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/schema", pathParams), Method.Post);
            this.Parser.Query(request, queryParams, queryStructNames);
            request.AddJsonBody(JsonSerializer.Serialize(payload));
    ...
    public async Task<BackendSchemaCollection> GetAll(int startIndex, int count, string search)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/schema", pathParams), Method.Get);
            this.Parser.Query(request, queryParams, queryStructNames);

...
public class BackendActionTag : TagAbstract {
    ...
    public async Task<CommonMessage> Delete(string actionId)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/action/$action_id<[0-9]+|^~>", pathParams), Method.Delete);
    ...
    public async Task<CommonMessage> Update(string actionId, BackendActionUpdate payload)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/action/$action_id<[0-9]+|^~>", pathParams), Method.Put);
            this.Parser.Query(request, queryParams, queryStructNames);
    ...
    public async Task<BackendAction> Get(string actionId)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/action/$action_id<[0-9]+|^~>", pathParams), Method.Get);
            this.Parser.Query(request, queryParams, queryStructNames);
            ...
            if (response.IsSuccessful)
            {
                return this.Parser.Parse<BackendAction>(response.Content);
            }
    ...
    public async Task<BackendActionExecuteResponse> Execute(string actionId, BackendActionExecuteRequest payload)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/action/execute/:action_id", pathParams), Method.Post);
            this.Parser.Query(request, queryParams, queryStructNames);
            request.AddJsonBody(JsonSerializer.Serialize(payload));
            ...
            if (response.IsSuccessful)
            {
                return this.Parser.Parse<BackendActionExecuteResponse>(response.Content);
            }
    ...
    public async Task<CommonFormContainer> GetForm(string _class)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/action/form", pathParams), Method.Get);
            this.Parser.Query(request, queryParams, queryStructNames);
    ...
    public async Task<BackendActionIndex> GetClasses()
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/action/list", pathParams), Method.Get);
            this.Parser.Query(request, queryParams, queryStructNames);
            ...
            if (response.IsSuccessful)
            {
                return this.Parser.Parse<BackendActionIndex>(response.Content);
            }
    ...
    public async Task<CommonMessage> Create(BackendActionCreate payload)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/action", pathParams), Method.Post);
            this.Parser.Query(request, queryParams, queryStructNames);
            request.AddJsonBody(JsonSerializer.Serialize(payload));
    ...
    public async Task<BackendActionCollection> GetAll(int startIndex, int count, string search)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/action", pathParams), Method.Get);
            this.Parser.Query(request, queryParams, queryStructNames);
            ...
            if (response.IsSuccessful)
            {
                return this.Parser.Parse<BackendActionCollection>(response.Content);
            }

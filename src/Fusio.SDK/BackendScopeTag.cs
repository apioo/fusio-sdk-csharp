...
public class BackendScopeTag : TagAbstract {
    ...
    public async Task<CommonMessage> Delete(string scopeId)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/scope/$scope_id<[0-9]+|^~>", pathParams), Method.Delete);
    ...
    public async Task<CommonMessage> Update(string scopeId, BackendScopeUpdate payload)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/scope/$scope_id<[0-9]+|^~>", pathParams), Method.Put);
            this.Parser.Query(request, queryParams, queryStructNames);
    ...
    public async Task<BackendScope> Get(string scopeId)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/scope/$scope_id<[0-9]+|^~>", pathParams), Method.Get);
            this.Parser.Query(request, queryParams, queryStructNames);
    ...
    public async Task<BackendScopeCategories> GetCategories()
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/scope/categories", pathParams), Method.Get);
            this.Parser.Query(request, queryParams, queryStructNames);
    ...
    public async Task<CommonMessage> Create(BackendScopeCreate payload)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/scope", pathParams), Method.Post);
            this.Parser.Query(request, queryParams, queryStructNames);
            request.AddJsonBody(JsonSerializer.Serialize(payload));
    ...
    public async Task<BackendScopeCollection> GetAll(int startIndex, int count, string search)
    {
        try
        {
            ...
            RestRequest request = new RestRequest(this.Parser.Url("/backend/scope", pathParams), Method.Get);
            this.Parser.Query(request, queryParams, queryStructNames);
